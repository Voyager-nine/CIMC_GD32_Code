...
ebtn_btn_t static_buttons[] = {
    ...
    EBTN_BUTTON_INIT(USER_BUTTON_3, &key_param_normal), // KEY3, ID=3, 使用 'key_param_normal' 参数
    EBTN_BUTTON_INIT(USER_BUTTON_4, &key_param_normal), // KEY4, ID=4, 也使用 'key_param_normal' 参数
    EBTN_BUTTON_INIT(USER_BUTTON_5, &key_param_normal), // KEY5, ID=5, 使用 'key_param_normal' 参数
    EBTN_BUTTON_INIT(USER_BUTTON_6, &key_param_normal), // KEY6, ID=6, 也使用 'key_param_normal' 参数	
};
